...
Once the conditions as outlined in "system requirements" are met, this gem can be utilized. 
	...
	<code>testr = Groupr.new</code><br/>
	<code>testr.key = "path to key file"</code><br/>
	<code>testr.cert = "path to certificate file"</code><br/>
	<code>testr.group_exists?("u_nikky_awesome") </code><br/>
	<code>testr.create_group("u_nikky_yeast-lords")</code><br/>
